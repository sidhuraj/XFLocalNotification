...
namespace NotificationSample.Droid
{
    class NotificationHelper : INotification
    {
        ...
        public void CreateNotification(String title, String message)
        {
            try
            {
                //Handle Push Notifications Concepts:Add Below these 4 lines//
                ...
                mBuilder = new NotificationCompat.Builder(mContext, "10023");
                ...
                //Handle Push Notifications Concepts: add Below One Line//
